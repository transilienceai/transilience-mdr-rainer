---
name: git-ai-security-weekly-report
description: Build concise Git shadow-AI security reports from git-shadow-ai-detection outputs, including models and providers, agent frameworks, MCP tooling, prompts, RAG/vector usage, training or eval artifacts, AI supply-chain dependencies, CI/CD usage, confidence levels, and prioritized remediation. Use when Codex needs to consolidate Git AI findings into Markdown, CSV, and JSON reporting artifacts for MDR or security review.
---
